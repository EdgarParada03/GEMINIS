 ...
 * @author edgar
 */
public class AlumnosPrincipalScreen extends javax.swing.JFrame {

    /**
     * Creates new form AlumnosPrincipalScreen
     */
    public AlumnosPrincipalScreen() {
        initComponents();
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtMatriculaAlumno, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtApellidoAlumno, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
    ...
    private void btnGuardarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarAlumnoActionPerformed
        ...
        btnGuardarAlumno.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                alumnoBuilder.setNombre(txtNombreAlumno.getText());
                alumnoBuilder.setApellido(txtApellidoAlumno.getText());
                alumnoBuilder.setMatricula(txtMatriculaAlumno.getText());

                Alumno alumno = alumnoBuilder.build(); // Aquí obtienes el objeto Alumno construido

                dbHandler.guardarPersona(alumno);

                System.out.println("Alumno guardado con nombre: " + alumno.getNombre() + " " +alumno.getApellido()
                        + " y matricula numero: " + alumno.getMatricula());

                txtNombreAlumno.setText("");
                txtApellidoAlumno.setText("");
                txtMatriculaAlumno.setText("");
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlumnosPrincipalScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlumnosPrincipalScreen().setVisible(true);
            }
        });
    }
